  ...
  const features = [
    {
      ...
      Icon: <CreditCard style={{ fontSize: 40 }} color="primary" />,
    },
    {
      Title: "Feature 2",
      Desc: "A breif description of feature 2",
      Icon: <DeviceTablet style={{ fontSize: 40 }} color="primary" />,
    },
    {
      Title: "Feature 3",
      Desc: "A breif description of feature 3",
      Icon: <Chat style={{ fontSize: 40 }} color="primary" />,
    },
    {
      Title: "Feature 4",
      Desc: "A breif description of feature 4",
      Icon: <LockClosed style={{ fontSize: 40 }} color="primary" />,
    },
  ];
