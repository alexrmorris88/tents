  ...
  return (
    <Card {...other}>
      ...
      <PropertyList>
        ...
        <Divider />
        <PropertyListItem align={align} label="ID" value={order._id} />
        <Divider />
        <PropertyListItem
          align={align}
          label="Invoice"
        ...
        <PropertyListItem
          align={align}
          label="Date"
          value={moment(order.createdAt).format("LL")}
        />
        <Divider />
        <PropertyListItem align={align} label="Promotion Code" value={"N/A"} />
        <Divider />
        <PropertyListItem
          align={align}
          label="Total Amount"
